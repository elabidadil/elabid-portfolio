...
hamburgerIcon.addEventListener('click', () => {
  ...
  document.querySelector.body.classList.toggle("bodyPointerEvents");
})
...
lightThemeButton.addEventListener('click', () => {
  ...
  document.querySelector(".contactButton a").classList.add("lightPgaeButtonsLink");
  document.querySelector(".projectsButton a").classList.add("lightPgaeButtonsLink");
  document.querySelector(".linkedinButton a").classList.add("lightPgaeButtonsLink");
  document.querySelector(".githubButton a").classList.add("lightPgaeButtonsLink");
  document.querySelector(".codepenButton a").classList.add("lightPgaeButtonsLink");
})
...
darkThemeButton.addEventListener('click', () => {
  ...
  document.querySelector(".contactButton a").classList.remove("lightPgaeButtonsLink");
  document.querySelector(".projectsButton a").classList.remove("lightPgaeButtonsLink");
  document.querySelector(".linkedinButton a").classList.remove("lightPgaeButtonsLink");
  document.querySelector(".githubButton a").classList.remove("lightPgaeButtonsLink");
  document.querySelector(".codepenButton a").classList.remove("lightPgaeButtonsLink");
})
